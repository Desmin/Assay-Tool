...
//        DateTimeZone mst2 = DateTimeZone.forID(jdkMST.getAssayID());
//        System.out.println(jdkMST);
//        jdkMST.setAssayID("America/Denver");
//        System.out.println(jdkMST);
//        System.out.println(jdkDenver);
//        System.out.println(jdkDenver.equals(jdkMST));
//        System.out.println(jdkMST.getAssayID());
//        System.out.println(mst.getAssayID() + (mst.isFixed() ? " Fixed" : " DST"));
//        System.out.println(mst2.getAssayID() + (mst2.isFixed() ? " Fixed" : " DST"));
...
//        System.out.println(dtz.getAssayID());
